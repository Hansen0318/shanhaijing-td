...
test('all six Boss HUDs use one variable-positioned code-driven fill without image masks', async () => {
  ...
  assert.match(main, /Renderer\.js\?v=level8-1/);
  assert.match(main, /UIController\.js\?v=level8-1/);
  assert.match(main, /artAssets\.js\?v=level8-1/);
  assert.match(ui, /artAssets\.js\?v=level8-1/);
  assert.match(renderer, /artAssets\.js\?v=level8-1/);
