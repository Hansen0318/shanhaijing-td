...
test('all Boss HUDs use one variable-positioned code-driven fill without image masks', async () => {
  ...
  assert.match(main, /Renderer\.js\?v=boss-hud-2/);
  assert.match(main, /UIController\.js\?v=boss-hud-2/);
  assert.match(main, /artAssets\.js\?v=boss-hud-2/);
  assert.match(ui, /artAssets\.js\?v=boss-hud-2/);
  assert.match(renderer, /artAssets\.js\?v=boss-hud-2/);
