import { Game } from './core/Game.js?v=attack-identity-1';
import { Renderer } from './render/Renderer.js?v=attack-identity-1';
    ...
    if (document.body.classList.contains('art-loading') && renderer.art.isLevelReady(game.levelId)) {
      ...
      if (!initialLoadRecorded) {
        globalThis.__SHANHAIJING_LOAD_METRICS__ = {
          ...
          failedAssets: renderer.art.failedForLevel(game.levelId),
        };
