...
export const TOWER_DATA = Object.freeze({
  ...
  xuangui: { id: 'xuangui', name: '玄龜', emoji: '🐢', role: '潮震控場', cost: 145, damage: 13, interval: 1.2, range: 140, projectileSpeed: 360, shockEvery: 4, shockDelay: 0.35, shockRadius: 52, shockDamage: 18, shockPushback: 18 },
});
...
export const LEVEL8_WAVE_DATA = Object.freeze([
  wave([{ type: 'changyou', count: 6 }], 1.1),
  wave([{ type: 'changyou', count: 8 }], 1),
  wave([{ type: 'changyou', count: 6 }, { type: 'gudiao', count: 2 }], 1),
  wave([{ type: 'gudiao', count: 4 }], 1.05),
  wave([{ type: 'changyou', count: 10 }, { type: 'gudiao', count: 3 }], 0.9, { hpMultiplier: 1.06 }),
  wave([{ type: 'changyou', count: 14 }, { type: 'gudiao', count: 4 }], 0.78, { hpMultiplier: 1.12 }),
...
export const BLESSING_DATA = Object.freeze([
  ...
  { id: 'jumangDamage', name: '青羽', description: '句芒傷害 +20%', tower: 'jumang', effect: { key: 'jumangDamage', add: 0.2 }, weight: 1 },
  { id: 'jumangRange', name: '神木', description: '句芒射程 +15%', tower: 'jumang', effect: { key: 'jumangRange', add: 0.15 }, weight: 1 },
  { id: 'jumangSpring', name: '春生', description: '句芒全隊攻擊間隔額外 -2%', tower: 'jumang', effect: { key: 'jumangSpring', add: 1 }, weight: 1 },
  { id: 'xuanguiWave', name: '玄波', description: '玄龜潮震傷害 +20%', tower: 'xuangui', effect: { key: 'xuanguiShockDamage', add: 0.2 }, weight: 1 },
  { id: 'xuanguiBroadTide', name: '闊潮', description: '玄龜潮震範圍 +8', tower: 'xuangui', effect: { key: 'xuanguiShockRadius', add: 8 }, weight: 1 },
  { id: 'xuanguiReturnTide', name: '回瀾', description: '玄龜潮震擊退 +5', tower: 'xuangui', effect: { key: 'xuanguiShockPushback', add: 5 }, weight: 1 },
...
export const LEVEL8_MAP_DATA = Object.freeze({
  width: 390,
  height: 610,
  pathWidth: 54,
  pathSmoothing: 24,
  clampPathSmoothing: false,
  // Geometry Guide V1 is vertically registered ~48 source px below the clean runtime background.
  // 48 / 1536 * 610 ~= 19 logical px, so all guide-derived Y coordinates are corrected by -19.
  waypoints: [
...
const levelEight = Object.freeze({
  id: 8,
  name: '幽冥沼澤',
  baseName: '幽冥靈核',
  bossType: 'huashe',
  bossVictoryRequiresWaveClear: true,
  map: LEVEL8_MAP_DATA,
  waves: LEVEL8_WAVE_DATA,
  art: Object.freeze({
    background: 'level8Background', backgroundCrop: { x: 0, y: 0, width: 780, height: 1220 },
    bossPanel: 'huasheBossPanel',
  }),
  lineup: Object.freeze({
    eyebrow: '第八關・幽冥沼澤', title: '第8關・幽冥沼澤',
    help: '本關從已擁有異獸中選擇三隻出戰<br>敵情：長右與蠱雕借潮穿越濕地，化蛇強制喚起高潮<br>推薦職能：控制／全隊增益／範圍攻擊',
  }),
});
